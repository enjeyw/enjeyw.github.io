...
![Training Loss](smartkv/train_all_layers_loss.png)
...
![ROC Curves](smartkv/all_layers_roc.png)
...
![Calibration Plot](smartkv/all_heads_binary_calibration.png)
...
![Confusion Matrix 0.5](smartkv/layer0_cm.png)
